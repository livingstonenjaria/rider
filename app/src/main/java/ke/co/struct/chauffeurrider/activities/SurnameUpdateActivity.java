...
public class SurnameUpdateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ab.setTitle(R.string.surname_update);
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    if (dataSnapshot.exists()) {
                        ...
                        if (map.get("surname") != null) {
                            str_name = map.get("surname").toString();
            ...
            public void onClick(View view) {
                ...
                if (str_name != null) {
                    if (isNetworkAvailable()) {
                        ...
                        update.put("surname", str_name);
                        updateid.updateChildren(update);
                        mProgress.dismiss();
                        Toast.makeText(SurnameUpdateActivity.this, R.string.surname_updated,Toast.LENGTH_SHORT).show();
                    }
                    else{
                        mProgress.dismiss();
                        Toast.makeText(SurnameUpdateActivity.this, R.string.offline, Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
    ...
    private void checkNetworkStatus(){
        if (!isNetworkAvailable()){
            Snackbar mySnackbar = Snackbar.make(findViewById(R.id.surname_layout),
